...
//     const [processing, setProcessing] = useState(true); // start as "processing"
//     const [checkpoint, setCheckpoint] = useState("Starting..."); // initial text
...
//                 sessionStorage.setItem(`recommendations_${canonicalArxivId}`, JSON.stringify(data.recommendations || []));
//             } catch (err) {
//                 console.error(err);
//             } finally {
//                 setLoadingRecommendations(false);
...
//                 setPaper(paperData);
//
//                 // 2️⃣ Send to backend for PDF processing
...
//     }, [arxivId]);
//
//     // Only clear sessionStorage once when component unmounts
//     useEffect(() => {
//         return () => {
